...
ggplot(stepsPerDay, aes(steps)) +
        ...
        ylab("Frequency") +
        theme(plot.title = element_text(family = "Helvetica", size=22, face="bold"),
...
# Checking imputed data for the variable "steps":
...
ggplot(stepsPerDay2, aes(steps)) +
        ...
        ggtitle("Histogram of the total number of steps taken each day imputating missing values") +
        xlab("Total steps per day") +
        ylab("Frequency") +
        theme(plot.title = element_text(family = "Helvetica", size=22, face="bold"),
              axis.title.x = element_text(family = "Helvetica", size=18),
